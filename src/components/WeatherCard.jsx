...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4'>
      <div className='flex w-20 justify-center, items-center gap-4 mt-8 mb-4'>
      ...
      <div className=' w-full flex justify-between items-center mt-4 gap-4'>
        <p className=' flex-1 text-center p-2 font-bold bg-blue-500 shadow rounded-lg'>Wind speed <p className=' font-normal'>{windspeed} km/h</p></p>
